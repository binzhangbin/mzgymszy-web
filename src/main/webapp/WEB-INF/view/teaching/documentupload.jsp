...
function commit(){
	var options ={   
            url:'${ctx }/teachingVideo/documentupload.html?count='+(i-1),   
            type : "POST", 
            dataType : "json",
            data:null,
