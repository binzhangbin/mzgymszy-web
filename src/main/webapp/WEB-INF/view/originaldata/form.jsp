		...
		<form id="originaldataForm" name="originaldataForm"
			...
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypFoldId">所属目录</label>
				<div class="col-sm-9">
					<div class="clearfix">
						<input class="form-control" name="gypFoldName" id="gypFoldName"
							type="text" value="${gypFoldName }" placeholder="请选择所属目录..."
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input class="form-control" name="gypBm" id="gypBm" type="text"
							value="${originaldataEntity.gypBm }" placeholder="编码..."
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input class="form-control" name="gypMcZm" id="gypMcZm"
							...
							placeholder="主名称..." maxlength="10" required />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="checkbox">
						...
						<label> <input class="ace" name="gypScdDw" id="gypScdDw"
							type="checkbox" value="个人"
							${originaldataEntity.gypScdDw eq "个人"?"checked":""} required /> <span
							class="lbl">个人</span>
						</label> <label> <input class="ace" name="gypScdDw" id="gypScdDw"
							type="checkbox" value="公司"
							${originaldataEntity.gypScdDw eq "公司"?"checked":""} required /> <span
							class="lbl">公司</span>
						</label> <label> <input class="ace" name="gypScdDw" id="gypScdDw"
							type="checkbox" value="馆藏"
							${originaldataEntity.gypScdDw eq "馆藏"?"checked":""} required /> <span
							class="lbl">馆藏</span>
						</label> <label> <input class="ace" name="gypScdDw" id="gypScdDw"
							type="checkbox" value="其它"
							${originaldataEntity.gypScdDw eq "其它"?"checked":""} required /> <span
							class="lbl">其它</span>
						</label>
					</div>
				</div>
			...
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypScdDq">样品归属人地区</label>
				<div class="col-sm-9">
					<div class="clearfix">
						<select class="form-control" name="gypScdDq" id="gypScdDq">
							<option>---请选择地区---</option>
							<option value="呼和浩特市"
								${originaldataEntity.gypScdDq eq "呼和浩特市"?"selected":""}>呼和浩特市</option>
							<option value="包头市"
								${originaldataEntity.gypScdDq eq "包头市"?"selected":""}>包头市</option>
							<option value="乌海市"
								${originaldataEntity.gypScdDq eq "乌海市"?"selected":""}>乌海市</option>
							<option value="赤峰市"
								${originaldataEntity.gypScdDq eq "赤峰市"?"selected":""}>赤峰市</option>
							<option value="通辽市"
								${originaldataEntity.gypScdDq eq "通辽市"?"selected":""}>通辽市</option>
							<option value="鄂尔多斯市"
								${originaldataEntity.gypScdDq eq "鄂尔多斯市"?"selected":""}>鄂尔多斯市</option>
							<option value="呼伦贝尔市"
								${originaldataEntity.gypScdDq eq "呼伦贝尔市"?"selected":""}>呼伦贝尔市</option>
							<option value="乌兰察布市"
								${originaldataEntity.gypScdDq eq "乌兰察布市"?"selected":""}>乌兰察布市</option>
							<option value="巴彦淖尔市"
								${originaldataEntity.gypScdDq eq "巴彦淖尔市"?"selected":""}>巴彦淖尔市</option>
							<option value="兴安盟"
								${originaldataEntity.gypScdDq eq "兴安盟"?"selected":""}>兴安盟</option>
							<option value="阿拉善盟"
								${originaldataEntity.gypScdDq eq "阿拉善盟"?"selected":""}>阿拉善盟</option>
							<option value="锡林郭勒盟"
								${originaldataEntity.gypScdDq eq "锡林郭勒盟"?"selected":""}>锡林郭勒盟</option>
						</select>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypCyzSf">曾用者身份</label>
				<div class="col-sm-9">
					<div class="checkbox">
						<label> <input class="ace" name="gypCyzSf" id="gypCyzSf"
							type="checkbox" value="贵族"
							${originaldataEntity.gypCyzSf eq "贵族"?"checked":""} required /> <span
							class="lbl">贵族</span>
						</label> <label> <input class="ace" name="gypCyzSf" id="gypCyzSf"
							type="checkbox" value="平民"
							${originaldataEntity.gypCyzSf eq "平民"?"checked":""} required /> <span
							class="lbl">平民</span>
						</label> <label> <input class="ace" name="gypCyzSf" id="gypCyzSf"
							type="checkbox" value="僧侣"
							${originaldataEntity.gypCyzSf eq "僧侣"?"checked":""} required /> <span
							class="lbl">僧侣</span>
						</label> <label> <input class="ace" name="gypCyzSf" id="gypCyzSf"
							type="checkbox" value="不祥"
							${originaldataEntity.gypCyzSf eq "不祥"?"checked":""} required /> <span
							class="lbl">不祥</span>
						</label>
					</div>
				</div>
			...
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypZsZsfs">装饰方式</label>
				<div class="col-sm-9">
					<div class="checkbox">
						<label> <input class="ace" name="gypZsZsfs" id="gypZsZsfs"
							type="checkbox" value="刺绣"
							${originaldataEntity.gypZsZsfs eq "刺绣"?"checked":""} required />
							<span class="lbl">刺绣</span>
						</label> <label> <input class="ace" name="gypZsZsfs"
							id="gypZsZsfs" type="checkbox" value="印染"
							${originaldataEntity.gypZsZsfs eq "印染"?"checked":""} required />
							<span class="lbl">印染</span>
						</label> <label> <input class="ace" name="gypZsZsfs"
							id="gypZsZsfs" type="checkbox" value="镶嵌"
							${originaldataEntity.gypZsZsfs eq "镶嵌"?"checked":""} required />
							<span class="lbl">镶嵌</span>
						</label> <label> <input class="ace" name="gypZsZsfs"
							id="gypZsZsfs" type="checkbox" value="雕刻"
							${originaldataEntity.gypZsZsfs eq "雕刻"?"checked":""} required />
							<span class="lbl">雕刻</span>
						</label> <label> <input class="ace" name="gypZsZsfs"
							id="gypZsZsfs" type="checkbox" value="包边"
							${originaldataEntity.gypZsZsfs eq "包边"?"checked":""} required />
							<span class="lbl">包边</span>
						</label> <label> <input class="ace" name="gypZsZsfs"
							id="gypZsZsfs" type="checkbox" value="缝制花边"
							${originaldataEntity.gypZsZsfs eq "缝制花边"?"checked":""} required />
							<span class="lbl">缝制花边</span>
						</label> <label> <input class="ace" name="gypZsZsfs"
							id="gypZsZsfs" type="checkbox" value="宝石"
							${originaldataEntity.gypZsZsfs eq "宝石"?"checked":""} required />
							<span class="lbl">宝石</span>
						</label> <label> <input class="ace" name="gypZsZsfs"
							id="gypZsZsfs" type="checkbox" value="其它装饰方式"
							${originaldataEntity.gypZsZsfs eq "其它装饰方式"?"checked":""} required />
			...
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypZsZta">装饰-主图案</label>
				<div class="col-sm-9">
					<div class="checkbox">
						<label> <input class="ace" name="gypZsZta" id="gypZsZta"
							type="checkbox" value="植物花卉"
							${originaldataEntity.gypZsZta eq "植物花卉"?"checked":""} required />
							<span class="lbl">植物花卉</span>
						</label> <label> <input class="ace" name="gypZsZta" id="gypZsZta"
							type="checkbox" value="动物"
							${originaldataEntity.gypZsZta eq "动物"?"checked":""} required /> <span
							class="lbl">动物</span>
						</label> <label> <input class="ace" name="gypZsZta" id="gypZsZta"
							type="checkbox" value="自然"
							${originaldataEntity.gypZsZta eq "自然"?"checked":""} required /> <span
							class="lbl">自然</span>
						</label> <label> <input class="ace" name="gypZsZta" id="gypZsZta"
							type="checkbox" value="几何"
							${originaldataEntity.gypZsZta eq "几何"?"checked":""} required /> <span
							class="lbl">几何</span>
						</label> <label> <input class="ace" name="gypZsZta" id="gypZsZta"
							type="checkbox" value="文字"
							${originaldataEntity.gypZsZta eq "文字"?"checked":""} required /> <span
							class="lbl">文字</span>
						</label> <label> <input class="ace" name="gypZsZta" id="gypZsZta"
							type="checkbox" value="宗教信仰"
							${originaldataEntity.gypZsZta eq "宗教信仰"?"checked":""} required />
							<span class="lbl">宗教信仰</span>
						</label> <label> <input class="ace" name="gypZsZta" id="gypZsZta"
							type="checkbox" value="其它"
							${originaldataEntity.gypZsZta eq "其它"?"checked":""} required /> <span
							class="lbl">其它</span>
						</label>
					</div>
				</div>
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<textarea class="form-control" name="gypZsMs" id="gypZsMs"
							...
							placeholder="装饰描述..." maxlength="1000" required />
					</div>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypZsGjzp">装饰工具照(完整)</label>
				<div class="col-sm-9">
					<div class="input-group">
						<input class="form-control picture-upload" name="gypZsGjzp"
							id="gypZsGjzp" type="text"
							value="${originaldataEntity.gypZsGjzp }"
							placeholder="装饰工具照片(完整)..." /> <span class="input-group-addon">
			...
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypZzclCz">制作材料材质</label>
				<div class="col-sm-9">
					<div class="checkbox">
						<label> <input class="ace" name="gypZzclCz" id="gypZzclCz"
							type="checkbox" value="金属"
							${originaldataEntity.gypZzclCz eq "金属"?"checked":""} required />
							<span class="lbl">金属</span>
						</label> <label> <input class="ace" name="gypZzclCz"
							id="gypZzclCz" type="checkbox" value="石材、宝石"
							${originaldataEntity.gypZzclCz eq "石材、宝石"?"checked":""} required />
							<span class="lbl">石材、宝石</span>
						</label> <label> <input class="ace" name="gypZzclCz"
							id="gypZzclCz" type="checkbox" value="皮、毛"
							${originaldataEntity.gypZzclCz eq "皮、毛"?"checked":""} required />
							<span class="lbl">皮、毛</span>
						</label> <label> <input class="ace" name="gypZzclCz"
							id="gypZzclCz" type="checkbox" value="骨、角"
							${originaldataEntity.gypZzclCz eq "骨、角"?"checked":""} required />
						...
						<label> <input class="ace" name="gypZzclCz" id="gypZzclCz"
							type="checkbox" value="木材"
							${originaldataEntity.gypZzclCz eq "木材"?"checked":""} required />
							<span class="lbl">木材</span>
						</label> <label> <input class="ace" name="gypZzclCz"
							id="gypZzclCz" type="checkbox" value="其它"
							${originaldataEntity.gypZzclCz eq "其它"?"checked":""} required />
			...
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypSygnSych">使用场合</label>
				<div class="col-sm-9">
					<div class="checkbox">
						<label> <input class="ace" name="gypSygnSych"
							id="gypSygnSych" type="checkbox" value="日常使用"
							${originaldataEntity.gypSygnSych eq "日常使用"?"checked":""} required />
							<span class="lbl">日常使用</span>
						</label> <label> <input class="ace" name="gypSygnSych"
							id="gypSygnSych" type="checkbox" value="宗教信仰活动"
							${originaldataEntity.gypSygnSych eq "宗教信仰活动"?"checked":""}
							required /> <span class="lbl">宗教信仰活动</span>
						</label> <label> <input class="ace" name="gypSygnSych"
							id="gypSygnSych" type="checkbox" value="民俗礼仪"
							${originaldataEntity.gypSygnSych eq "民俗礼仪"?"checked":""} required />
							<span class="lbl">民俗礼仪</span>
						</label> <label> <input class="ace" name="gypSygnSych"
							id="gypSygnSych" type="checkbox" value="重大节日"
							${originaldataEntity.gypSygnSych eq "重大节日"?"checked":""} required />
							<span class="lbl">重大节日</span>
						</label> <label> <input class="ace" name="gypSygnSych"
							id="gypSygnSych" type="checkbox" value="其它"
							${originaldataEntity.gypSygnSych eq "其它"?"checked":""} required />
							<span class="lbl">其它</span>
						</label>
					</div>
				</div>
			...
			<div class="form-group">
				<label class="control-label col-sm-2 no-padding-right"
					for="gypDyrTbsj">填表时间</label>
				<div class="col-sm-9">
					<div class="input-group">
						<input class="form-control form_datetime" name="gypDyrTbsj"
							id="gypDyrTbsj" type="text" placeholder="填表时间..."
				...
				<div class="col-sm-9">
					<div class="clearfix">
						<input class="form-control" name="gypBz" id="gypBz" type="text"
							value="${originaldataEntity.gypBz }" placeholder="备注..."
							maxlength="50" />
					</div>
				</div>
			</div>
