		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="#" class="navbar-brand"> 
					<small> 
						<img src="${ctx }/resources/images/logo_no_title.png" height="25px"/> 民族工艺美术资源库系统
					</small>
				</a>
	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar responsive">
			...
			<c:forEach var="resource" items="${list}" varStatus="s">
					...
					<a href="javascript:void(0)" <c:if test="${fn:length(fn:trim(resource.sourceUrl)) gt 0 }"> nav-menu="${resource.name },${resource.sourceUrl }"</c:if> <c:if test="${fn:length(resource.children) gt 0 }"> class="dropdown-toggle"</c:if>> 
		...
		<div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<span class="bigger-120"> <span class="red bolder">民族工艺美术资源库系统</span>
						 &copy; 2016
					</span>
				</div>
