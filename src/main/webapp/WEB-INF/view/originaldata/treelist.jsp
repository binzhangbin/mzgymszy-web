...
$(function () {
	$('#tree')
		...
		.on('select_node.jstree', function (e, data) {
			webside.common.loadPage('/originaldata/listUI.html?foldId='+data.selected);
...
function customSearch() {
    webside.common.loadPage('/originaldata/listUI.html?searchKey='+$("#searchKey").val());
}
</script>
<div class="page-header">
	<shiro:hasPermission name="originaldata:add">
	<button id="btnAdd" type="button" onclick="webside.common.addModel('/originaldata/addUI.html')" class="btn btn-red btn-sm">
