...
public class LogAspect {
	 ...
	 */
	@Pointcut("execution(* com.imu.mzgymszy.*.controller.*.add(..))")
	 ...
	 */
	@Pointcut("execution(* com.imu.mzgymszy.*.controller.*.update(..)) "
			+ "|| execution(* com.imu.mzgymszy.*.controller.*.resetPassword(..)) "
			+ "|| execution(* com.imu.mzgymszy.*.controller.*.info(..)) "
			+ "|| execution(* com.imu.mzgymszy.*.controller.*.password(..))")
	 ...
	 */
	@Pointcut("execution(* com.imu.mzgymszy.*.controller.*.delete*(..))")
	 ...
	 */
	@Pointcut("execution(* com.imu.mzgymszy.*.controller.*.permission(..))")
