...
function commit(){
	var options ={   
            url:'${ctx }/originaldata/mediaupload.html?count='+(i-1),   
            type : "POST", 
            dataType : "json",
            data:null,
