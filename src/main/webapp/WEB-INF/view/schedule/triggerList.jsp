...
<div class="page-header">
	...
	<button id="btnAdd" type="button" onclick="webside.common.addModel('/scheduleJob/addTriggerUI.html?jobName=${scheduleJobEntity.jobName }&jobGroup=${scheduleJobEntity.jobGroup }')" class="btn btn-red btn-sm">
