package com.imu.mzgymszy.index.controller;
...
import com.imu.mzgymszy.logininfo.service.LoginInfoService;
...
import com.imu.mzgymszy.util.TreeUtil;
		...
		try {
	        ...
	        }else
	        {
				...
				if (subject.isAuthenticated()) {
					...
					loginInfo.setLoginIp(request.getHeader("X-Real-IP")==null||request.getHeader("X-Real-IP").equals("")?SecurityUtils.getSubject().getSession().getHost():request.getHeader("X-Real-IP"));
