...
<link href="${ctx }/resources/images/icon.ico" rel="icon" />
<link href="${ctx }/resources/images/icon.ico" type="image/x-icon" rel="bookmark" />
<link href="${ctx }/resources/images/icon.ico" type="image/x-icon" rel="shortcut icon" />
